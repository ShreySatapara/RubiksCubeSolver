...
#Last Edited on: 20/3/2019
#Written by: shreysatapara
...
#GUI portion of the Cube Solver
#............................................................
#globals used for the GUI
root = None
frame = None
canvas = None
ScrambleLabel = None
...
def cubePoints():
    ...
    return [    [[u00p, u01p, u02p],
                ...
                [[l00p, l01p, l02p],
                 [l10p, l11p, l12p],
                 [l20p, l21p, l22p]], #front face 

                [[r02p, r12p, r22p],
                 [r01p, r11p, r21p],
                 [r00p, r10p, r20p]], # right face
...
#Used to allow user to enter in their own scramble in the Entry
